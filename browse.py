...
Sanmple shows how to implement a simple hi resolution image nacigation
...
if __name__=='__main__':
    ...
    def onmouse(event,x,y,flags,param):
        ...
        zoom=cv2.getRecSubPix(img,(800,600),(x+0.5,y+0.5))
        cv2.imshow('zoom'.zoom)
        
    cv2.imshow('preview',small)
    cv2.setMouseCallback('precview',onmouse)
    cv2.waitKey()
